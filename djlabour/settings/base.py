...
ROOT_URLCONF = 'djlabour.core.urls'
WSGI_APPLICATION = 'djlabour.wsgi.application'
STATICFILES_DIRS = ()
STATICFILES_FINDERS = (
...
CACHES = {
    'default': {
        ...
        #'LOCATION': '/var/tmp/django_djlabour_cache',
        #'TIMEOUT': 60*20,
        #'KEY_PREFIX': 'djlabour_',
        #'OPTIONS': {
        #    'MAX_ENTRIES': 80000,
        #}
    }
...
SESSION_COOKIE_NAME ='django_djlabour_cookie'
